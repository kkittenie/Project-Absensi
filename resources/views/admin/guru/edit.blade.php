...
@section('content')
    <div class="container-fluid p-0">
        ...
        <div class="page-header row mb-4">
            <div class="col-12">
                <h1 class="h3 mb-0"><strong>Edit</strong> Guru</h1>
                <p class="text-muted mb-0">Edit data guru</p>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('admin.guru.update', $guru->uuid) }}" method="POST" enctype="multipart/form-data"
                    id="formEditGuru">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="nip" value="{{ old('nip', $guru->nip) }}"
                                ...
                                maxlength="18" minlength="18" pattern="\d{18}" inputmode="numeric"
                                oninput="this.value=this.value.replace(/\D/g,'')">
                        </div>

                        <div class="col-md-6 mb-3">
                            <label class="form-label">Nomor Telepon</label>
                            <input type="text" name="nomor_telepon" value="{{ old('nomor_telepon', $guru->nomor_telepon) }}"
                    ...
                    <div class="row">
                        ...
                        <div class="mb-4">
                            ...
                            @if ($guru->photo)
                                <div class="mt-2">
                                    <img src="{{ asset('storage/' . $guru->photo) }}" width="100" height="100"
